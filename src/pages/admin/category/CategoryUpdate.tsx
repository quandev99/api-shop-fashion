  ...
  return (
    <form onSubmit={handleSubmit(onHandleSubmit as any)}>
      <div className="relative overflow-x-auto sm:rounded-lg mb-5">
        <div className=" w-full text-sm text-left text-gray-500 dark:text-gray-400 grid grid-cols-2 gap-5">
          <div>
            ...
            <input
              ...
              {...register("category_name", {
                ...
                minLength: { value: 6, message: "Tối thiểu 5 kí tự" },
              })}
          ...
          <div>
            ...
            <input
              type="text"
              defaultValue={category?.category_images}
              {...register("category_images", {
                required: "Image không được bỏ trống",
              })}
              className=" shadow-md w-full px-3 py-4 rounded-md mt-2 focus:border-b border-b  focus:border-blue-400  focus:duration-150 outline-none hover:shadow text-[16px]"
            />
            <div className="text-red-500">
              {errors.category_images?.message}
            </div>
          </div>
        </div>
      </div>
      <div className="mb-4">
        ...
        <button className="bg-green-600 px-10 py-2 duration-200 hover:bg-green-700 cursor-pointer rounded-md text-white">
          Update
        </button>
      </div>
    </form>
